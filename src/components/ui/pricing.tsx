...
import { updateQuan } from "@/lib/store/slices/CartSlices";
import { useSelector } from "react-redux";
import { useAppDispatch, useAppSelector } from "@/lib/store/hooks";
import { setTrue, toggle } from "@/lib/store/slices/PlanSlices";
...
export default function Pricing({
 ...
 const PlanOpen = useAppSelector(state => state.plan)
